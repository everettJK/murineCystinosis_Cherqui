...
showed an expanded clone (30% relative abundance) with an integration event down stream of the non-coding RNA gene LOC105374704. 
...
```{r, echo=FALSE, fig.height=7, results='asis', cache=FALSE}
n <- 1
